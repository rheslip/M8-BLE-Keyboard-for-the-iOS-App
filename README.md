...
The prototype worked very well so I have designed a PCB and enclosure which more or less duplicates the M8 V1 design - Kailh switches, approx 96mm x 84mm x18mm, white silkscreen. It has a small RGB led for indicating battery status and pads for a switch. I couldn't find a suitable PCB mounted R/A slide switch so I went with PCB pads so you can put in whatever you have. There are pads for a lipo charger module as well.
